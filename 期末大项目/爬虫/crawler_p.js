// 新闻来源
let source_name = "人民日报海外版";
// 编码格式
let myEncoding = "utf-8";
// 主页URL
let seedURL = 'http://en.people.cn/';
let myURL = "";
// Jquery全局对象
let seedURL_format = "$('*')";
// 正则表达式
let url_reg = /n3\/\d{4}\/\d{4}/;
...
function getHotNews(res, myURL) {
    ...
    const Content = $('div[class="w860 d2txtCon cf"]');
    ...
    fetch.author= $('div[class="origin cf"]').eq(0).text()
